...
defaultproperties
{
    ...
    AchDefs(5)=(id="VSS_FA",DisplayName="Full-Auto Sniper",Description="Score 5 headshots with VSS Vintorez without releasing a trigger (x%c)",Icon=Texture'ScrnAch_T.Achievements.Checked',MaxProgress=10,DataSize=6)
    ...
    AchDefs(9)=(id="Hunting4Kills",DisplayName="Line up and shot",Description="Kill 4 zeds with a single shot of Hunting rifle (x%c)",Icon=Texture'ScrnAch_T.Achievements.Checked',MaxProgress=10,DataSize=4)
    ...
    AchDefs(13)=(id="SPAS_Auto",DisplayName="Pump Action, AA12 Behavior",Description="Deal 5000 damage with SPAS-12 without releasing a trigger",Icon=Texture'ScrnAch_T.Achievements.Checked',MaxProgress=1,DataSize=1)
    ...
    AchDefs(19)=(id="VAL_FA",DisplayName="Full-Auto Commando Sniper",Description="Score 5 headshots with VAL without releasing a trigger %c times",Icon=Texture'ScrnAch_T.Achievements.Checked',MaxProgress=15,DataSize=4)
    AchDefs(20)=(id="HK417",DisplayName="H&K 4x17",Description="Score 4x17 kills with HK417 without reloading",Icon=Texture'ScrnAch_T.Achievements.Checked',MaxProgress=4,DataSize=3)
    ...
    AchDefs(28)=(id="RPG_Ammo",DisplayName="Rocket Saver",Description="Finish %c waves without running out of RPG7 ammo. 30 kills required.",Icon=Texture'ScrnAch_T.Achievements.Checked',MaxProgress=10,DataSize=4)
